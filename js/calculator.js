...
function calculate() {
    var firstInput = document.getElementById('first'); //casting
    var first = firstInput.valueAsNumber;
    var secondInput = document.getElementById('second'); //casting
    var second = secondInput.valueAsNumber;
    var operatorInput = document.getElementById('operator'); //casting
